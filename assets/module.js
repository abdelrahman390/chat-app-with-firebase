...
async function handleNewUser() {
    try {
        const newUser = await waitForNewUser();  // Wait for the Promise to resolve
...
// // handle all chats messages
// function handleAllChatsMessages() {
//     let senderLastFourNums = sessionStorage.getItem("sender_id").slice(-2)
...
//             // if(allUsers[key].user_name !== sessionStorage.getItem("sender")){
//                 let receiverLastFourNums = key.slice(-2);
//                 // let chatId = receiverLastFourNums + senderLastFourNums;
//                 // console.log(allChats); 
